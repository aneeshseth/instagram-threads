...
function page() {
    ...
    return (
      <div className="container" style={{backgroundImage: "https://image.lexica.art/full_jpg/50c16465-9200-4bba-9089-d65c32b3981f", opacity: "0.2", minHeight: "100vh"}}>
        <button onClick={() => setTheme("system")}>🌙</button>
        <button onClick={() => setTheme("light")}>🔅</button>
        <Card className="w-[350px]">
        <CardHeader>
          <CardTitle>Login into Yeetcode</CardTitle>
